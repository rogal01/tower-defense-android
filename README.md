...
This project is one of the strongest examples in my portfolio because it combines game systems design, cross-platform architecture, rendering, progression, and long-term content support in one codebase.
...
- **Cross-platform architecture**: the gameplay systems live in a shared Kotlin Multiplatform module while each platform keeps native rendering and platform-specific integrations.
- **No external game engine**: rendering is done with Android Canvas and iOS SpriteKit rather than Unity or Godot.
- **Procedural presentation**: visuals are hand-drawn in code instead of relying on sprite packs.
- **Large gameplay surface**: towers, traps, bosses, powers, campaign content, meta progression, and achievements all work together in one system.
...
- progression systems like skills, campaign data, and achievements
...
- engine-free rendering
- large-scope feature integration
- long-form technical project execution
